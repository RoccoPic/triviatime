    ...
    <main className="min-h-screen p-4 md:p-8 text-zinc-100">
      <div className="max-w-2xl mx-auto">
        ...
        <section className="mb-8 p-4 rounded-lg bg-zinc-900 border border-zinc-700">
          ...
          <p className="text-zinc-500 text-sm mt-1">50% of run money is added here when a run ends.</p>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-3">
            ...
            {Object.keys(categories).length === 0 && (
              <p className="text-zinc-500">Play some runs to see category stats.</p>
            )}
          </div>
        </section>
            ...
            {runs.slice(0, 10).map((r) => (
              ...
              >
                <div>
                  ...
                  <span className="text-zinc-500 text-sm ml-2">Floor {r.floor}</span>
                </div>
